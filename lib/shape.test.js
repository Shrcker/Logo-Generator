...
const triangle = new Triangle("blue", "red", "SVG");
const circle = new Circle("red", "blue", "SVG");
const square = new Square("yellow", "purple", "SVG");
...
describe("Shape sublcasses", () => {
  ...
  test("If the circle object is outputting correct data", () => {
    ...
    <svg version="1.1" width="300" height="200">
      ...
      <text x="150" y="110" font-size="50" text-anchor="middle" fill="blue">SVG</text>
    </svg>
    `);
  });
  test("If the square object is outputting correct data", () => {
    ...
    <svg version="1.1" width="300" height="200">
      ...
      <text x="175" y="120" font-size="70" text-anchor="middle" fill="purple">SVG</text>
    </svg>
    `);
  });
});
